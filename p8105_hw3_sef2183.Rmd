...
jan_tmax_line = 
  ...
  mutate(mean_tmax = mean(tmax, na.rm = TRUE)) %>% 
  ggplot(aes(x = year, y = mean_tmax, group = id, color = id)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) + geom_line(show.legend = FALSE) + ylab("mean maximum temperature") + ggtitle("Avg max temp in January")
...
jul_tmax_line = 
  ...
  mutate(mean_tmax = mean(tmax, na.rm = TRUE)) %>% 
  ggplot(aes(x = year, y = mean_tmax, group = id, color = id)) + 
  theme(axis.text.x = element_text(angle = 90,hjust = 1)) + geom_line(show.legend = FALSE) + ylab("mean maximum temperature") + ggtitle("Avg max temp in July")
...
* There are outliers in the data for both months. In January, there was a weather station that recorded a very low mean average temperature of about -16 degrees C around 1982. In July, there was also a weather station that recorded a low mean average temperature of about 19 degrees C around 1984, an even temperature of about 14 degrees C around 1987, and outliers of around about 18 and 19 degrees C around 2003 and 2006.
...
Below, a two-panel plot depicting
